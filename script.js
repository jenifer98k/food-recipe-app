...
//et mealsDetailsContent=document.getElementsByClassName('meal-details-content');
...
.then(data=>{
    ...
    if(data.meals){
      ...
      <div class="meal-img">
        <img src="${meal.strMealThumb}" alt="food" height="300px" width="0px">
      </div>
      <div class="meal-name">
       <h3>${meal.strMeal}</h3>
    ...
    ;
        ...
        html="Sorry we didn't find meal";
...
<div class="recipe-meal-img">
  <img src="${meal.strMealThumb}" alt="" width="500px"  height="500px">
</div>
